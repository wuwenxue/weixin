...
public class TikiboxWeiXinServlet extends HttpServlet {

	private static final long serialVersionUID = -4267408236898837036L;

	
	private static final Log log = LogFactory.getLog(TikiboxWeiXinServlet.class);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			String retXml = tikiboxEngineService.process(baseMsgDto);
			out.print(retXml);
		} catch (Exception e) {
			e.printStackTrace();
		}
